...
|                                                                                                                |                                                                       |
| -------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| **[Portable — one file](https://github.com/bahuckel/EDEXO-Compare/releases/download/v1.1.2/EDExoCompare.exe)** | Download and run. Unpacks itself somewhere temporary each time.       |
| **[Program folder — .zip](https://github.com/bahuckel/EDEXO-Compare/releases/tag/v1.1.2-zip)**                 | Extract and keep. Starts faster, and includes the two console builds. |
