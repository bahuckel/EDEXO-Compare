...
const MATERIAL_TABLES: Record<string, Record<string, string>> = {
  ...
  "Bacterium nebulus": { Antimony: "Magenta", Polonium: "Gold", Ruthenium: "Orange", Tellurium: "Green", Yttrium: "Cobalt" },
  "Bacterium vesicula": { Antimony: "Cyan", Polonium: "Orange", Ruthenium: "Mulberry", Technetium: "Gold", Tellurium: "Red", Yttrium: "Lime" },
  "Bacterium volu": { Antimony: "Red", Polonium: "Aquamarine", Ruthenium: "Cobalt", Tellurium: "Cyan", Yttrium: "Gold" },
  "Bacterium omentum": { Cadmium: "Lime", Mercury: "White", Molybdenum: "Aquamarine", Niobium: "Peach", Tungsten: "Blue", Tin: "Red" },
  "Bacterium scopulum": { Cadmium: "White", Mercury: "Peach", Molybdenum: "Lime", Niobium: "Red", Tungsten: "Aquamarine", Tin: "Mulberry" },
  "Bacterium tela": { Cadmium: "Gold", Mercury: "Orange", Molybdenum: "Yellow", Niobium: "Magenta", Tungsten: "Green", Tin: "Cobalt" },
  "Bacterium verrata": { Cadmium: "Peach", Mercury: "Red", Molybdenum: "White", Niobium: "Mulberry", Tungsten: "Lime", Tin: "Blue" },
};
